...
| 구분 | 표준 | 버전/근거 | 비고 |
|------|------|-----------|------|
| 국내 지침(웹) | **KWCAG** (한국형 웹 콘텐츠 접근성 지침) | 2.2 = KS X OT0003 / TTAK.OT-10.0003/R2 (4원칙·14지침·33항목) | 최신은 2.2, **법정 인증 심사는 아직 2.1(24항목)** |
| 국내 지침(앱) | **MACAG 2.0** (모바일 앱 콘텐츠 접근성 지침) | KS 국가표준(2016), 4원칙·18항목 | **네이티브 앱** 전용 → `macag` 스킬, **MA 인증** |
| 국내 법 | 장애인차별금지법, **지능정보화기본법(§46 접근보장·§47 품질인증)**, 전자정부법 | 공공+일정규모 민간 의무 | 미준수 시 차별 진정 대상 |
...
**네이티브 앱**은 별도 표준(MACAG 2.0)·별도 인증(MA)이므로 `macag` 스킬을 본다.
...
> 스크린리더별 동작 모델·단축키·제스처·이름 계산·모바일 특화·흔한 버그·환경 셋업의 **심화는
> `screen-readers.md`**, 초점 흐름 심화는 **`focus-management.md`** 참고.
